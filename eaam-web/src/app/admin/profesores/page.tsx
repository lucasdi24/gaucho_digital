        ...
        <div className="flex justify-between items-center mb-10 border-b border-white/10 pb-8">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-2xl font-black">EAAM — Gestión de Profesores</h1>
            </div>
            <p className="text-slate-500 text-sm">Agregá, editá o eliminá profesores del equipo docente.</p>
          </div>
